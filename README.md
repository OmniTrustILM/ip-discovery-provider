...
| `DISCOVERY_PROBE_CONNECT_TIMEOUT_MS` | Milliseconds to wait for the TCP connection to a scanned target. Must be positive | ![](https://img.shields.io/badge/-NO-red.svg) | `500` |
